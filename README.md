...
**A fork of [TokenTracker](https://github.com/mm7894215/TokenTracker) focused on quality-per-token and quality-per-dollar optimization.**

**English** · [简体中文](./README.zh-CN.md) · [日本語](./README.ja.md) · [한국어](./README.ko.md)

### Know exactly what you're spending on AI — and what it bought you — across every CLI
